    ...
    <div className="page-shell" style={{ display: 'flex', flexDirection: 'column', gap: '28px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '20px' }}>
        <div>
          ...
          <p style={{ fontSize: '32px', color: 'rgba(148,163,184,.9)', lineHeight: 1.2 }}>
                ...
                <div style={{ textAlign: 'right' }}>
                  <span
                    style={{
                      fontSize: '18px',
                      fontWeight: 800,
                      color: GRADE_COLOR[ev.grade] || '#94a3b8',
                      display: 'block',
                  ...
                  <span style={{ fontSize: '11px', fontWeight: 700, color: GRADE_COLOR[ev.grade] || '#94a3b8' }}>{ev.grade}</span>
                </div>
              </Link>
            ))}
          </div>
        ) : (
          <p style={{ fontSize: '13px', color: 'rgba(148,163,184,.4)', padding: '8px 10px' }}>No evaluations yet</p>
        )}
      </div>
    </div>
  );
